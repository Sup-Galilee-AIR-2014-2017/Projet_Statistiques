...
//		BufferedReader ReadIn = getBuffer();
	...
	public static double getDaviesBouldinIndice(ArrayList<ArrayList<Double>> repartition) {
		...
		int k = repartition.size(); //ici, k vaut le nombre de groupes (pas sur, k doit peut �tre �tre le nombre de centres d�finis al�atoirement tout au d�but dde l'algo).
